...
#***************************************
def _making_dataframe(model_type, pred_df,auc_roc_list_grid,r2_list_grid):
    """
...
def predict_feature_importance(model_type,featurizer_kind, data_to_predict, model_path, input_df, id_col, smiles_col, response_col):
    """
    ...
    while i <= numberOfColumns + 1:
        ...
        _making_dataframe(model_type, pred_df, auc_roc_list_grid, r2_list_grid)
        tempFeaturizer = data_to_predict.copy()
